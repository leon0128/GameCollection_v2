...
debug:
	$(CC) main/main.cpp main/game.cpp main/input_system.cpp main/mathematics.cpp main/renderer.cpp main/actor.cpp main/controller.cpp main/texture.cpp main/shader.cpp main/vertex_array.cpp component/component.cpp  $(CFLAGS) $(LIBS) -o $(PROGRAM)